...
SOCKETIO_ROLE = "server"
# SOCKETIO_SERVER_ADDRESS = "192.168.2.90"
SOCKETIO_SERVER_ADDRESS = "63.32.119.241"
...
class RTCamNamespace(socketio.Namespace):
...
class SocketIOCamServer():
    ...
    def __init__(self):
        ...
        self.sio.register_namespace(RTCamNamespace())
...
with picamera.PiCamera(resolution='1280x720', framerate=10, sensor_mode=4) as camera:
    try:
        camera.rotation = 180
